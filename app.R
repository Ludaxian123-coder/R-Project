...
setwd("D:/MITB course arrangement document/course document/R/Group project/ISSS616 Final Project")
#DATA1#
...
ggplot(googlesentiment,aes(x=reorder(word,score),y=score,colour=sentiment,fill=sentiment))+
  geom_col(alpha=0.5)+
  xlab("Words")+
  ylab("Scores")+
  coord_flip()
